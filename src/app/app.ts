    ...
    return html`
      ...
      <div class="row-layout main-navigation">
        <igc-navbar class="navbar">
          <div class="row-layout group">
            <div @click="${() => Router.go(`/test-web-components/home`)}" class="row-layout group_1">
      ...
      <div class="row-layout bottom-container">
        ...
        <igc-nav-drawer position="end" id="nav-drawer" class="nav-drawer">
          <igc-nav-drawer-item @click="${() => Router.go(`/test-web-components/home`)}">
            <span slot="icon">
          ...
          <igc-nav-drawer-item @click="${() => Router.go(`/test-web-components/health-indicators`)}">
            <span slot="icon">
              <span class="material-icons icon_1">
                favorite
              </span>
